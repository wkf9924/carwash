...
-(void)setUpPageControl:(NSArray *)array
{
    ...
    pageControl.frame = CGRectMake(self.frame.size.width/2-pageSize.width/2, self.frame.size.height/2+10, pageSize.width, pageSize.height);
//    pageControl.center = CGPointMake(self.bounds.origin.x,self.bounds.origin.y+20);
