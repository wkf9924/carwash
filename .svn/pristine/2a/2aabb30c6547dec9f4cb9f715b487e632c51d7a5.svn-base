...
#import "QRCodeVC.h"
@interface VIPCarVC () <UITableViewDelegate, UITableViewDataSource,BZEventCenterDelegate,MKMapViewDelegate>
...
-(void)eventCenter:(BZEventCenter *)eventCenter eventType:(NSString *)eventType callbackParam:(id)param{
    if ([eventType isEqualToString:CWEventCenterTypeSellerInfo]) {
        ...
        self.tableViewHight.constant = 40.0f;
...
//    _SuperTableView.hidden = YES;
    ...
    [UIBarButtonItem barButtonItemWithBackgroundImage:[UIImage imageNamed:@"更多icon"]
     ...
     [self.tableView registerNib:[UINib nibWithNibName:@"VIPSellerCell" bundle:nil] forCellReuseIdentifier:@"VIPSellerCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    VIPSellerCell *cell = [tableView dequeueReusableCellWithIdentifier:@"VIPSellerCell" forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    QRCodeVC *setingVC = [setingStoryBoard instantiateViewControllerWithIdentifier:@"QRCodeVIPVC"];
    COM.shopType = @"会员";
    setingVC.orderID = @"";
    [self.navigationController pushViewController:setingVC animated:YES];
}
